...
<a href="/upload" class="upload-button"><span class="nav-text">Upload</span></a> <a href="/create/gifmaker" class="create-button"><span class="nav-text">Create</span></a>
...
<span>Information Collected Using Cookies:</span>
